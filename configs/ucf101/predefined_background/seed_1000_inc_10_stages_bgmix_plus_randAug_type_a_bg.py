...
work_dir = 'work_dirs/seed_1000_inc_10_stages_bgmix_plus_randAug_type_a_bg'
...
background_dir = os.path.join(data_dir, 'bg_extract_type_c_fast_crop_i2_s100')
data = dict(
    train=dict(
        type=dataset_type,
