...
work_dir = 'work_dirs/seed_1000_inc_10_stages_bgmix_plus_randAug_type_c_bg'
...
background_dir = os.path.join(data_dir, 'place365_val_no_person')
data = dict(
    train=dict(
        type=dataset_type,
