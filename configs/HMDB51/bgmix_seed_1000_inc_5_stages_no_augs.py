...
mode disable both randAug amd bgmix
    randAug_prob = -1               # disable randAug
    
    train=dict(    
        with_randAug=False,         # let BackgroundMixDataset work independently to randAug
        prob=-1                     # not use bgmix
    }
