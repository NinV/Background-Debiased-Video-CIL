...
model = dict(
    ...
    cls_head=dict(
        ...
        num_classes=51 + task_index * 10,
        in_channels=512,
        inc_head_config=dict(type='LocalSimilarityClassifier', out_features=51 + task_index * 10, nb_proxies=1),
        num_segments=8,
...
data = dict(
    ...
    workers_per_gpu=8,   # single gpu setting
